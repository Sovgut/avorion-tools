...
const TURRET: IntlTurret = {
    ...
    [TurretType.Bolter]: "Автоматическая пушка прикрытия",
    [TurretType.Laser]: "Лазер прикрытия",
    [TurretType.PlasmaGun]: "Лазер",
    [TurretType.Cannon]: "Рудный лазер",
    [TurretType.RocketLauncher]: "Груборудный лазер",
    [TurretType.Railgun]: "Утилизационный лазер",
    [TurretType.Repair]: "Лазер для грубой утилизации",
    [TurretType.MiningLaser]: "Плазменная пушка",
    [TurretType.RawMiningLaser]: "Ракетная установка",
    [TurretType.SalvagingLaser]: "Орудие",
    [TurretType.RawSalvagingLaser]: "Рельсовая пушка",
    [TurretType.ForceGun]: "Ремонт",
    [TurretType.TeslaGun]: "Болтер",
    [TurretType.LightningGun]: "Молниевая пушка",
    [TurretType.PulseCannon]: "Пушка Тесла",
    [TurretType.PointDefenseCannon]: "Силовая пушка",
    [TurretType.PointDefenseLaser]: "Импульсное орудие",
    [TurretType.AntiFighter]: "Против истребителей",
}

const SELLER: IntlSeller = {
    [SellerType.TurretFactorySupplier]: "Фабрика турелей",
    [SellerType.TurretFactory]: "Поставщик фабрики турелей",
    [SellerType.AluminumMine]: "Планетарная торговая фактория",
    [SellerType.AmmunitionFactory]: "Солнечная электростанция",
    [SellerType.ConductorFactory]: "Производитель Провод",
    [SellerType.CopperMine]: "Ферма (Кристалл)",
    [SellerType.PlanetaryTradingPost]: "Рудник благородного металла",
    [SellerType.CrystalFarm]: "Алюминий шахта",
    [SellerType.ElectroMagnetFactory]: "Медь шахта",
    [SellerType.ElectromagneticChargeFactory]: "Свинец шахта",
    [SellerType.SolarPowerPlant]: "Цинк шихта",
    [SellerType.EnergyContainerFactory]: "Фабрика компьютерных комплектующих",
    [SellerType.EnergyInverterFactory]: "Фабрика боеприпасов",
    [SellerType.EnergyTubeFactory]: "Фабрика трансформаторов Тесла",
    [SellerType.ExplosiveChargeFactory]: "Фабрика Проводник",
    [SellerType.ForceGeneratorFactory]: "Фабрика Электромагнит",
    [SellerType.FuelFactory]: "Фабрика Электромагнитный заряд",
    [SellerType.GaussRailFactory]: "Фабрика Аккумулятор",
    [SellerType.NobleMetalMine]: "Фабрика Инвертор энергии",
    [SellerType.HighCapacityLensFactory]: "Фабрика Энергетическая труба",
    [SellerType.HighPressureTubeFactory]: "Фабрика Заряд взрывчатого вещества",
    [SellerType.TeslaCoilFactory]: "Фабрика Генератор силового поля",
    [SellerType.LaserCompressorFactory]: "Фабрика Топливо",
    [SellerType.LaserHeadFactory]: "Фабрика Рельсовая пушка Гаусса",
    [SellerType.LaserModulatorFactory]: "Фабрика Линза для мощного лазера",
    [SellerType.LeadMine]: "Фабрика Труба высокого давления",
    [SellerType.NanobotFactory]: "Фабрика Лазерный компрессор",
    [SellerType.PlasmaCellFactory]: "Фабрика Лазерная головка",
    [SellerType.PowerUnitFactory]: "Фабрика Лазерный модулятор",
    [SellerType.RocketFactory]: "Фабрика Наноробот",
    [SellerType.ServoFactory]: "Фабрика Плазменный элемент",
    [SellerType.SteelFactory]: "Фабрика Силовая установка",
    [SellerType.SteelTubeFactory]: "Фабрика Ракета",
    [SellerType.ComputerComponentFactory]: "Фабрика Сервомеханизм",
    [SellerType.TargetingCardFactory]: "Фабрика Сталь",
    [SellerType.TransformatorFactory]: "Фабрика Стальная труба",
    [SellerType.WarheadFactory]: "Фабрика Карта наведения",
    [SellerType.WireManufacturer]: "Фабрика Трансформатор",
